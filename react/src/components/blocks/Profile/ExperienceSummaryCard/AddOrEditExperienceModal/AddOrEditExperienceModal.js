...
function AddOrEditExperienceModal({ show, handleModalClose }) {
  ...
  return (
    <>
      <Modal show={show} handleModalClose={handleModalClose} title="Add a Experience">
          ...
          <form onSubmit={handleSubmit(handleCreateChannelFormSubmit)}>
            ...
            <div className={styles.formContainer}>
              ...
              {formState.errors?.title && (
                <span className={`${styles.error} ${styles.subLabel}`}>title_error</span>
              )}
            </div>
            ...
            <div className={styles.formContainer}>
              ...
              {formState.errors?.employment_type && (
                <span className={`${styles.error} ${styles.subLabel}`}>employment_type_error</span>
              )}
            </div>
            ...
            <div className={styles.formContainer}>
              ...
              {formState.errors?.company_name && (
                <span className={`${styles.error} ${styles.subLabel}`}>company_name_error</span>
              )}
            </div>
            ...
            <div className={styles.formContainer}>
              ...
              {formState.errors?.location && (
                <span className={`${styles.error} ${styles.subLabel}`}>location_error</span>
              )}
            </div>
            ...
            <div className={styles.formContainer}>
              ...
              {formState.errors?.description && (
                <span className={`${styles.error} ${styles.subLabel}`}>description_error</span>
              )}
            </div>

            <div className={`${styles.formContainer} ${styles.createModalRight}`}>
